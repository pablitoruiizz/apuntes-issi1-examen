...
BEGIN
    ...
    INSERT INTO people (person_id, name, age, nationality) VALUES
        ...
        (19, 'Zinedine Zidane', 41, 'Francia'),
        (20, 'Santos', 58, 'Brasil'),
        (21, 'Pablo Pérez', 50, 'Argentina');
    ...
    INSERT INTO referees (referee_id, license) VALUES 
        ...
        (18, 'Nacional');
	  -- Entrenadores
	 INSERT INTO trainers (trainer_id, experiencia, especialidad) VALUES
	 	 (19, 4, 'Individual'),
		 (20, 4, 'Dobles'),
		 (21, 4, 'Dobles');
    -- Jugadores
    INSERT INTO players (player_id, ranking, entrenador_id) VALUES 
        (1, 1,21),
        (2, 2,19),
        (3, 4,19),
        (4, 5,20),
